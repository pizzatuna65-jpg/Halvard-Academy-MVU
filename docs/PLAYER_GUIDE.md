...
- **Bonds.** Meaningful scenes raise progress toward the next rank, with a daily cap. A full bar marks a **bond event ready**, and the rank only rises after a real milestone scene. Names, habits, goals and backstory unlock in the dossier as ranks rise. Secrets only surface through the story.
