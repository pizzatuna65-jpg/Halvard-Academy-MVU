...
- **Student file**: profile and **reputation**, body (injuries, weather conditions and training), your **Bag**, wallet, studies, magic, hidden magic (once relevant), **Gifts & perks** (once a bond has given you one), the engine log, and **Settings** (features and their token cost).
