...
const CHANGE = {"Etnie": "fixed", "Irene": "fixed", "Aiden": "shaped", "Castor": "shaped", "Zara": "shaped", "Kanae": "shaped", "Rei": "fixed", "Caine": "shaped", "Caralynn": "shaped", "Percival": "fixed", "Trixie": "fluid", "Vera": "fixed", "Alyssa": "fixed", "Lenna": "shaped", "Saffi": "fixed", "Idris": "shaped", "Dante": "fixed", "Florian": "fluid", "Tilly": "fixed", "Caspian": "fixed", "Royhan": "shaped", "Sophia": "fixed", "Gareth": "fixed", "Ruby": "fixed", "Gavlan": "fixed", "Yvette": "fixed", "Baelin": "fixed", "Layla": "fixed", "Vallie": "fixed", "Kuroo": "fixed", "Mimosa": "shaped", "Althair": "fixed", "Ezrel": "fixed", "Ottavio": "fixed", "Krieg": "fixed", "Milena": "shaped", "Tristan": "fixed", "Bobby": "shaped"};   // 1.6.0 (N2): fixed | shaped | fluid per NPC (data/npc_canon.json; empty until the canon waves)
...
const ENGINE_VER = "1.6.10";   // the card version (src/card/card.json, set by tools/gen_engine.py)
