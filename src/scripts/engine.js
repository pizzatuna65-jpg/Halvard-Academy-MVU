...
const OUTDOOR = ["archery range", "boathouse and lake", "broken statue", "combat grounds", "courtyards", "forest", "forest clearing", "founder's statue and park", "founders statue and park", "gardens", "grassy field and hills", "menagerie", "observation tower", "rooftop", "sports field", "swimming pool"];
