...
Field per NPC: Scene examples + Never sounds like, `term_used`, `DON'T FLATTEN` + `CARRIES`, `Change`, Stages (G1), Anchor. (Owner 2026-09-25: Stages untuk semua gelombang G1–G5, "tetap beri stages" lalu "ya" untuk G3–G5.)
